...
public final class JdbcWrapperHelper {
	...
	public static void rebindDataSource(ServletContext servletContext, String jndiName, DataSource dataSource, DataSource dataSourceProxy) throws
            Throwable {
	...
	public static void pullDataSourceProperties(String name, DataSource dataSource) {
		...
		if ("org.apache.tomcat.dbcp.dbcp.BasicDataSource".equals(dataSourceClassName) && dataSource instanceof org.apache.tomcat.dbcp.dbcp.BasicDataSource) {
	...
	private static Object changeContextWritable(ServletContext servletContext, Object lock) throws NoSuchFieldException,
		...
		if ((serverInfo.contains("Tomcat") || serverInfo.contains("vFabric") || serverInfo.contains("SpringSource tc Runtime")) && System
