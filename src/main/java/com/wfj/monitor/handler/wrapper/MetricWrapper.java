...
public class MetricWrapper {
    ...
    private void buildMetricRegistry() {
        sumInboundRequestCounts = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "counts", "sum", "inbound"));

        sumOutboundRequestCounts = slam.registry.counter(
                MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "counts", "sum", "outbound"));

        sumDealRequestCounts = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "counts", "sum", "deal"));

        sumErrDealRequestCounts = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "counts", "sum", "error"));

        sumErrDealRequestTime = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "time", "sum", "error"));

        sumDealRequestTime = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "time", "sum", "deal"));

        peerDealRequestTime = slam.registry
                .counter(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "time", "sum", "peer"));

        requestDetails = slam.registry
                .timer(MetricRegistry.name(MetricWrapper.METRIC_COUNTER_PATH, "request", "summer", "request"));
    }
}
