...
import com.wfj.monitor.dto.CounterRequest.ICounterRequestContext;
...
public class CounterRequestContext implements ICounterRequestContext, Cloneable, Serializable {
	...
	public CounterRequestContext(Counter parentCounter, CounterRequestContext parentContext, String requestName,
		...
		this(parentCounter, parentContext, requestName, completeRequestName, remoteUser, Thread.currentThread().getId(), System
